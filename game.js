...
const state={
  ...
  bpm:120, analyzedBeats:[], analysisReady:false, audioCtx:null, analyser:null, source:null, data:null, prevData:null, energyHistory:[], fluxHistory:[], detector:null, lastAutoBeat:-10, autoIntervals:[], autoLastPeak:null,
...
async function start(){
  ...
  state.beatIndex=0;state.lastBeat=-1;state.dead=false;state.paused=false;state.jumpBuffer=0;state.coyote=0;state.jumpHeld=false;
...
function spawnObstacle(){
  ...
  const minGap=Math.max(115,state.speed*17);
  ...
  if(r>.88)type="tall"; else if(r>.70)type="double";
